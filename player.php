...
<head>
    ...
    <script>
        ...
        var streamName = "Bass Breaker Radio"; // Station name
        var streamAddress = "192.168.1.2"; // Streaming server address
        var streamPort  = 8000; // Streaming server port
        var mp3Mount = ""; // Leave empty if shoutcast; no /
        var oggMount = "1"; // Leave empty if you don't have an ogg stream; no /
    ...
    <body>
        ...
        <div id="jp_container_1" class="jp-audio">
            <div class="jp-type-single">
                ...
                <div class="jp-title">
                    <ul>
                        <li id="title" style="display:none;visibility:hidden;"></li>
                        <marquee style="height:25px;"><li id="current_song"></li></marquee>
                    </ul>
                </div>
...
setInterval(function(){
    loadlink() // this will run after every 5 seconds
			...
			function loadlink(){
				$('#current_song').load('currsong.php');
			}
            $("#web4radio_1").bind($.jPlayer.event.play, function(event) {
                ...
                setTimeout(function() {
                    ...
                    if (android && time === 0) {
                        // If plalyback didn't start by now, it's probably a stock browser on Android < 4.1
